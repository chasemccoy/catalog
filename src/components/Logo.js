  ...
  return (
    <Container xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 16 16" {...rest}>
      <g fill="none" fillRule="evenodd">
        ...
        <path fill={color} className="square" fill-rule="evenodd" d="M10.5,7.5 L13,7.5 C13.2761424,7.5 13.5,7.72385763 13.5,8 L13.5,10.5 C13.5,10.7761424 13.2761424,11 13,11 L10.5,11 C10.2238576,11 10,10.7761424 10,10.5 L10,8 C10,7.72385763 10.2238576,7.5 10.5,7.5 Z" />
      </g>
    </Container>
  )
}
