...
const Container = styled(Link)`
  ...
  background-color: ${props =>
    props.highlight ? `${colors.primary.purple}` : `white`};
...
const Description = styled.div`
  margin: 0;
  ${props => props.highlight && `color: white !important;`} position: relative;
  overflow: hidden;
  line-height: 1.45em;
  ...
  &:after {
    ...
    ${props =>
      props.highlight &&
      `
      background: linear-gradient(to right, rgba(88, 86, 214, 0), ${
