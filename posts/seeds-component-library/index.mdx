...
<Callout mb='1em'>
  ...
  . Big thanks to{' '}
  <Link to='https://twitter.com/mxstbr?lang=en'>Max Stoiber</Link> for letting
  me share my work with the Styled Components readers.
</Callout>
...
![Our component library now lives right inside our design system, at sproutsocial.com/seeds/components](seeds.png 'Our component library now lives right inside our design system, at sproutsocial.com/seeds/components')
